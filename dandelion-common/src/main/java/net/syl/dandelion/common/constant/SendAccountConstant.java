...
public class SendAccountConstant {
     ...
     * 邮件 账号
     */
    public static final String EMAIL_ACCOUNT_PREFIX = "email.account.";

    /**
     * 钉钉群自定义机器人 账号
     */
    public static final String DING_DING_ROBOT_ACCOUNT_KEY = "dingDingRobotAccount";
    public static final String DING_DING_ROBOT_ACCOUNT_PREFIX = "ding-ding-robot.account.";
     ...
     * 短信 账号
     */
    public static final String SMS_TENCENT_ACCOUNT_PREFIX = "sms.tencent.account.";
    public static final String SMS_TENCENT_TEMPLATE_PREFIX = "sms.tencent.template-id.";
